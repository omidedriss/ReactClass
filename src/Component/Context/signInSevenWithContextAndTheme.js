...
import { AuthContext } from "./authContextThree";
import { ThemeContext } from "./themeContext";
import "./signIn.css";
const SignInSevenWithContextAndTheme = (props) => {
  ...
  return (
    ...
    >
      ...
      {authContext.authetication ? (
        <>
          <h1>Profile</h1>
          <Button clicked={() => logout()}>خروج</Button>
        </>
      ) : (
        <div>
          <input
...
export default SignInSevenWithContextAndTheme;
